Этот проект представляет собой **телеграмм бот на Python**, который использует **OpenAI API** для генерации текстовых ответов на запросы пользователей. Бот создан с помощью библиотеки **python-telegram-bot**.
